        ...
        <form onSubmit={handleSettlementSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                min="1"
                value={settleAmount}
                onChange={(e: ChangeEvent<HTMLInputElement>) => setSettleAmount(e.target.value)}
          ...
          <div>
            ...
            <input
              ...
              required
              value={settleDate}
              onChange={(e: ChangeEvent<HTMLInputElement>) => setSettleDate(e.target.value)}
          ...
          <div>
            ...
            <input
              type="text"
              value={settleNotes}
              onChange={(e: ChangeEvent<HTMLInputElement>) => setSettleNotes(e.target.value)}
